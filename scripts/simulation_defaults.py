"""
Default parameters, sensor models etc. for running simulations
"""
...
seed = 20212021
# seed = 20222022   # TEST SEED


def get_default_params():
    sim_params = SimulationParams()
    sim_params.max_time = 60.0
    ...
    sim_params.replan_rate = 1
    sim_params.detection_rate = 2
    sim_params.sensor_range = 20.0
    sim_params.range_short = 5.0
    sim_params.range_medium = 15.0
...
def get_default_sensors():
    ...
    #                                                     seed=seed)
    range_bearing_sensor = QuadraticProportionalNoiseRangeBearingSensor(
        range_proportion_min=range_proportion_min,
        range_proportion_max=range_proportion_max,
        max_range=p.sensor_range,
        bearing_sigma=np.deg2rad(2.5),
        seed=seed,
    )
