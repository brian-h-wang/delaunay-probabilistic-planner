...
class NoUncertaintyBaselineSimulation(Simulation):
    """
    ...
    This baseline planner considers the obstacle means only, without accounting for obstacle estimate uncertainty.
    """
